...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .card { aspect-ratio: 5/8; position:relative; transform-style:preserve-3d;
...
function cardHTML(frontImg, alt) {
  ...
  return `<div class="card"><div class="face back"><img data-src="cards-web/back.png" alt="card back"><span class="sheen"><span class="glint"></span></span></div>
    <div class="face front">${front}<span class="sheen"><span class="glint"></span></span></div></div>`;
}
...
function updateStackUI() {
  ...
  S.wrap.querySelector('#shint').textContent = seen
    ...
    : 'tap to reveal · swipe to shuffle through';
